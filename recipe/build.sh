...
if [[ "${target_platform}" == osx-arm64 ]]; then
    export EXTRA_MAKEFLAGS="$EXTRA_MAKEFLAGS USE_SYSTEM_BLAS=0 USE_BLAS64=0 USE_SYSTEM_ARPACK=0 USE_SYSTEM_LAPACK=0 USE_SYSTEM_CURL=0"
elif [[ "${target_platform}" != osx-arm64 ]]; then
    export EXTRA_MAKEFLAGS="$EXTRA_MAKEFLAGS USE_SYSTEM_BLAS=1 USE_BLAS64=1 USE_SYSTEM_ARPACK=1 USE_SYSTEM_LAPACK=1 USE_SYSTEM_CURL=1"
