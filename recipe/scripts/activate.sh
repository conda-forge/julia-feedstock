...
# Uncomment the export lines below for similar Julia depot behavior
# as on the 1.7 branch of the conda-forge release
...
#export JULIA_PROJECT="$CONDA_PREFIX/share/julia/environments/${CONDA_PREFIX##*/}"
